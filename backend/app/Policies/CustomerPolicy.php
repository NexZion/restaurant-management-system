...
class CustomerPolicy
{
    ...
    public function update(User $user, Customer $customer): bool { return $this->viewAny($user); }
    public function delete(User $user, Customer $customer): bool { return $this->viewAny($user); }
}
