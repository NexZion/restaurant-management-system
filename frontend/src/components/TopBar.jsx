      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            title="Notifications"
          >
            <Icon name="notification" className="w-6 h-6 text-gray-600 dark:text-gray-300" />
            {/* Notification Badge */}
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-[#212125] rounded-lg shadow-lg border border-gray-300 dark:border-gray-700 z-50">
              ...
              <div className="max-h-96 overflow-y-auto">
                ...
                <div className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition-colors">
                  <p className="text-sm text-gray-900 dark:text-white">Inventory low alert</p>
        ...
        <button
          ...
          title="Logout"
        >
          <Icon name="logout" className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors duration-200" />
        </button>
      </div>
    </div>
  )
